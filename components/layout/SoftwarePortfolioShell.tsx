...
/**
 * Full-bleed iframe wrapper for the interactive 3D journey (a separate
 * Vite/three.js WebGL app). The rest of the site is real React now — this
 * is the one page that stays iframed since it's a standalone WebGL build.
 */
    ...
    >
      <div className="relative min-h-0 overflow-hidden">
        ...
        <iframe
          ...
          src="/software-portfolio-app/game?mode=game"
